          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center justify-center md:justify-start gap-3">
                <i data-lucide="phone" className="w-5 h-5 text-amber-500"></i>
                <span className="font-medium">314 798 2292 <br /> 311 369 9929</span>
              </li>
              <li className="flex items-center justify-center md:justify-start gap-3">
                <i data-lucide="mail" className="w-5 h-5 text-amber-500"></i>
                <span className="font-medium">velassanpedropopayan@gmail.com</span>
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start justify-center md:justify-start gap-3">
                <i data-lucide="map-pin" className="w-5 h-5 text-amber-500 shrink-0 mt-1"></i>
                <span className="font-medium"><br />Cauca, Colombia</span>
              </li>
            </ul>
          </div>
        </div>
        <div className="border-t border-blue-400 mt-12 pt-8 text-center text-blue-200 text-sm">
          <p>&copy; {new Date().getFullYear()} Cerería San Pedro. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  )
